...
import { Calendar, MapPin, CheckCircle, GraduationCap, TestTube } from 'lucide-react';
import { education } from '../data';

export default function Education() {
  return (
    <section id="education" className="py-24 bg-neutral-950 text-white relative border-t border-neutral-900 overflow-hidden">
      {/* Visual background accents */}
      <div className="absolute top-[30%] left-[-10%] w-[25rem] h-[25rem] bg-indigo-650/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center gap-3 mb-16">
          <span className="text-xs font-mono text-indigo-500 uppercase tracking-widest font-semibold">Academic Journey</span>
          ...
          <p className="text-neutral-400 max-w-xl text-sm sm:text-base">
            Highlighting my academic background, degrees, and core computer science foundations.
          </p>
        </div>

        {/* Timeline Stack */}
        <div id="education-timeline" className="max-w-4xl mx-auto flex flex-col gap-12 relative before:absolute before:left-4 md:before:left-1/2 before:top-2 before:bottom-2 before:w-[2px] before:bg-neutral-800">
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-8">
                  <div className="p-6 rounded-2xl bg-neutral-900 border border-neutral-800/80 hover:border-indigo-500/30 transition-all duration-300 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="flex flex-col gap-2 mb-4">
                      <h3 className="text-xl font-bold text-white group-hover:text-indigo-500 transition-colors pr-20">
                        {exp.role}
                      </h3>
